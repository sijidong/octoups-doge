(function ($) {
    "use strict";
    var scrollTicker, lightboxAttr, sidebar, rtl = $('body').hasClass('rtl'),
    ...
    function stickyLogo() {
        ...
        if ($('body').hasClass('logo-overflow')) {} else if (height > parent.data('height')) {
    ...
    function mfnMobileSticky() {
        ...
        var menuH, windowH = $(window).height() || 0,
    ...
    function cf7popup(hash) {
        if (hash && $(hash).length) {
            ...
            $('a.popup-link[href="#' + id + '"]:not(.once)').addClass('once').trigger('click');
        }
    }
    $(document).ready(function () {
        ...
        $('.sections_group .gallery').each(function () {
            ...
            var id = el.attr('id');
            $('> br', el).remove();
            $('.gallery-icon > a', el).wrap('<div class="image_frame scale-with-grid"><div class="image_wrapper"></div></div>').prepend('<div class="mask"></div>').children('img').css('height', 'auto').css('width', '100%');
            if (el.hasClass('file')) {
                $('.gallery-icon a', el).attr('rel', 'prettyphoto[' + id + ']').attr('data-elementor-lightbox-slideshow', id);
            }
        ...
        $('.mfn-acc').each(function () {
            ...
            if (el.hasClass('openAll')) {
                ...
                if (activeTab) {
                    el.find('.question').eq(activeTab - 1).addClass("active").children(".answer").show();
                }
            }
        });
        ...
        $('.widget_mfn_menu ul.submenus-click').each(function () {
            ...
            $('a', el).on('click', function (e) {
                ...
                if (li.hasClass('hover') || !li.hasClass('menu-item-has-children')) {} else {
                    e.preventDefault();
    ...
    $(window).on('load', function () {
        ...
        function retinaLogo() {
            ...
            var el, src, height, parent = $('#Top_bar #logo'),
